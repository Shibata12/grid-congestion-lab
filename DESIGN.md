...
│   ├── d-algorithms/                # 領域D: 混雑演算のアルゴリズム
│   ├── e-market/                    # 領域E: 電力市場
│   └── f-dispatch-system/           # 領域F: 次期中央給電指令所システム
│
├── glossary/
...
│   └── ...
│
├── 領域D: 混雑演算のアルゴリズム (units/d-algorithms/index.html)
│   └── ...
│
├── 領域E: 電力市場 (units/e-market/index.html)
│   └── ...
│
├── 領域F: 次期中央給電指令所システム (units/f-dispatch-system/index.html)
│   └── ...
│
