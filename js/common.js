...
const SITE_STRUCTURE = {
  a: {
    ...
    units: [
      ...
      { id: 'a-05', title: '三相交流と単位法（per-unit）', file: '05-three-phase-and-per-unit.html', exerciseCount: 4,
      ...
      { id: 'a-07', title: '周波数と慣性──なぜ50Hzに保てるのか', file: '07-frequency-and-inertia.html', exerciseCount: 5,
