...
const SITE_STRUCTURE = {
  a: {
    ...
    units: [
      ...
      { id: 'a-04', title: '有効電力・無効電力と電圧', file: '04-active-reactive-voltage.html', exerciseCount: 3,
      ...
      { id: 'a-05', title: '三相交流と単位法（per-unit）', file: '05-three-phase-and-per-unit.html', exerciseCount: 3,
        summary: '送電線が3本1組（1回線）である理由と、電圧は線間・電力は3相合計という表記の約束、実務データを読むための単位法（pu＝値÷基準値）・%インピーダンスを学ぶ。' },
    ],
  },
  b: {
    name: '系統混雑',
  ...
  c: {
    ...
    units: [
      ...
      { id: 'c-06', title: '計測と状態推定', file: '06-measurement-and-state-estimation.html', exerciseCount: 3,
        summary: '誤差を含む計測値（テレメータ）から、物理法則と最もつじつまの合う「今」の系統状態を推定するしくみを、5つの時計のたとえで学ぶ。F-02「状態推定」の回収でC領域完結。' },
    ],
  },
  d: {
    name: '混雑計算のアルゴリズム',
  ...
  e: {
    ...
    units: [
      ...
      { id: 'e-09', title: '総合演習──ある日の連系線と市場を通しで解く', file: '09-integrated-exercise.html', exerciseCount: 8,
        summary: '新しい知識ゼロの制度・市場側の総仕上げ。公表イメージの読み取り→空容量→市場分断・値差→間接送電権の精算→地内混雑の運用対応まで、初見の数字で8問の数珠つなぎで通しで解く。D-05（計算側の総合演習）の対。' },
    ],
  },
  f: {
    name: '中央給電指令所システム',
